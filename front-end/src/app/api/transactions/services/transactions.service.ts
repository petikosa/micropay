...
export class TransactionsService extends BaseService {
  ...
  static readonly GetAllTransactionsPath = '/transactions/transactions';
   ...
   */
  getAllTransactions$Response(params?: GetAllTransactions$Params, context?: HttpContext): Observable<StrictHttpResponse<Transaction>> {
   ...
   * This method doesn't expect any request body.
   */
  getAllTransactions(params?: GetAllTransactions$Params, context?: HttpContext): Observable<Transaction> {
